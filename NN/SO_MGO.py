    ...
    def forward(self,fs0,fs1,fs2):
        ...
        for i in range(1,self.T//2+1):
            if i==1:
                ...
                offset_2.append(self.s2_opns[i-1](fs2[0],fs2[i]))
        ...
        for i in range(1,self.T//2+1):
            if i==1:
                ...
                offset_1.append(self.s1_opns[i-1](fs1[0],fs1[i],offset_2[i-1]))
        ...
        for i in range(1,self.T//2+1):
            if i==1:
                ...
                offset_0.append(self.s0_opns[i-1](fs0[0],fs0[i],offset_1[i-1]))
...
class SO_MGO(nn.Module):
    def __init__(self,T):
        super(SO_MGO,self).__init__()
        print('NN: ',self.__class__.__name__)
