...
class OTA(nn.Module):
    ...
    def forward(self,fea,off):
        ...
        return torch.cat(fea,1)*(1+F.softmax(att_fea,1))
...
class STO_OTA_v1(nn.Module):
    def __init__(self,T):
        super(STO_OTA_v1,self).__init__()
        print('NN: ',self.__class__.__name__)
